    ...
    <Container>
      <div className="h-588 flex-shrink-0 bg-dark pb-60">
        <div className="ml-40 pt-20 flex pb-20 items-center ">
          {/*<div className="w-8 h-1 bg-[#1D4B5B]"></div>*/}
          <Line />
        ...
        <div className="ml-40">
          <p className="text-light font-manrope text-5xl font-normal leading-7 tracking-wide">
            Szybka, fachowa i skuteczna
          </p>
          <p className="text-light font-manrope text-5xl font-normal leading-7 tracking-wide mt-2">
            pomoc prawna
          </p>
        </div>
